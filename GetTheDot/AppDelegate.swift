...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GADMobileAds.configure(withApplicationID: "ca-app-pub-6937210582976662~4138025295")
        
        //real ca-app-pub-6937210582976662~4138025295
        //change to real before publishing
        
        
        //If app has never been launched make Mute switch true
        if !UserDefaults.standard.bool(forKey: "isNotFirstLaunch") {
            //Set autoAdjustSettings and isNotFirstLaunch to true
            UserDefaults.standard.set(true, forKey: "muteSwitchState")
            ...
            UserDefaults.standard.set(0, forKey: "colorTag")
